...
Authorization.updateAuthRestriction();
//Authorization.checkAuthorized();
//Authorization.addAuthRestriction();
//Authorization.removeAuthRestriction();
//Authorization.getAuthRestriction();

//var sId = Authorization.ServiceIdentifier("Authorization","updateAuthorizationRestriction");
//
//var sRestr = Authorization.ServiceRestriction(3555, sId);
//
//var authRestr = Authorization.AuthorizationRestriction(sRestr);
//
//var update = Authorization.UpdateAuthorizationRestrictionRequest("u12118282", authRestr);
//var auth = new Authorization();

//auth.updateAuthorizationRestriction(update);
...
//authorize.updateAuthorizationRestriction(authorize.UpdateAuthorizationRestrictionRequest("u12118282",authorize.AuthorizationRestriction(authorize.ServiceRestriction(2,authorize.ServiceIdentifier("Authorization","updateAuthorisationRestriction")))));
